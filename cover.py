...
class OPiGPIOCover(CoverDevice):
    """Representation of a Orangepi GPIO cover."""
    ...
    def __init__(self, name, relay_pin, state_pin, state_pull_mode,
        ...
        opi_gpio.setup_output(self._relay_pin)
        opi_gpio.setup_input(self._state_pin, self._state_pull_mode)
        opi_gpio.write_output(self._relay_pin, 0 if self._invert_relay else 1)
    ...
    def update(self):
        ...
        self._state = opi_gpio.read_input(self._state_pin)
    ...
    def _trigger(self):
        """Trigger the cover."""
        opi_gpio.write_output(self._relay_pin, 1 if self._invert_relay else 0)
